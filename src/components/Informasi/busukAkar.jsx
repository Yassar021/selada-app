    ...
    return (
        <>
            ...
            <Flex direction="column" gap="10px" textAlign={"justify"}>
                <Box width={{ base: 'auto', lg: '345px' }} height={'345px'} bgImage={'/busukakar.png'} bgPosition={'center'} bgRepeat={'no-repeat'} bgSize={'cover'} borderRadius={'12px'}>
...
export function BusukAkarDesc() {
    return (
        <>
            ...
            <Text fontWeight={'600'} fontSize={"16px"}><br />Mengatasi Busuk Akar Hidroponik</Text>
            <Text textAlign={'justify'} fontSize={"16px"}>
